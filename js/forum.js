...
function buildList(){
    ...
    for(var i = 0; i < noteList.length; i++){
        ...
        liElm.innerHTML = "<a href='forumpost.html' class='kasser'><div class='pointMatematik'><p class='pointTekst'>0</p><p class='kommentarTekst'>0 komm.</p></div><div class='forumTekst'><p class='forumTitel'>" + noteList[i].text + "</p><div class='forumBund'><div class='flexBund'><p class='paddingRight'>" + noteList[i].fag + "</p><p class='paddingRight'> " + noteList[i].klasse + "</p></div><div class='flexBund'><p class='paddingLeft'>" + noteList[i].today + "</p><p class='paddingLeft'>af " + name + "</p></div></div></div></a>";
        }
